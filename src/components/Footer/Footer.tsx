...
const Footer: React.FC<FooterProps> = ({
  ...
  socialLinks = [
    { name: "Instagram", href: "https://instagram.com/carolinesnailshk", icon: "📷" },
    { name: "Facebook", href: "https://www.facebook.com/profile.php?id=61580409818825", icon: "📘" },
    { name: "Twitter", href: "/", icon: "🐦" },
  ],
  quickLinks = [
    { label: "Instagram", href: "https://instagram.com/carolinesnailshk", icon: <InstagramIcon /> },
    { label: "Facebook", href: "https://www.facebook.com/profile.php?id=61580409818825", icon: <FacebookIcon /> },
  ],
}) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
            ...
            <ul className="space-y-4">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a
                    href={link.href}
                    className="text-gray-400 hover:text-white hover:translate-x-2 transition-all duration-300 inline-flex items-center gap-2"
                  >
          ...
          <div>
            ...
            <button 
              ...
              className="btn-primary text-sm mt-8 w-full"
            >
              Rezervovat termín
            </button>
          </div>
